...
<script src="<?=URLROOT;?>/js/jquery-migrate-3.0.1.min.js"></script>
...
<script src="<?=URLROOT;?>/js/jquery.stellar.min.js"></script>
<script src="<?=URLROOT;?>/js/owl.carousel.min.js"></script>
<script src="<?=URLROOT;?>/js/jquery.magnific-popup.min.js"></script>
<script src="<?=URLROOT;?>/js/jquery.animateNumber.min.js"></script>
<script src="<?=URLROOT;?>/js/scrollax.min.js"></script>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
<script src="<?=URLROOT;?>/js/google-map.js"></script>
